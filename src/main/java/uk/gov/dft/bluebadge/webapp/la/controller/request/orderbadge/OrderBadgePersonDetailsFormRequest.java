...
@Data
@Builder
public class OrderBadgePersonDetailsFormRequest implements OrderBadgeBaseDetailsFormRequest, Serializable {
	...
	private static final String[] ALLOWED_FILE_TYPES = new String[] { "image/jpg", "image/jpeg", "image/png",
			"image/gif" };
	...
	@Pattern(regexp = ValidationPatterns.POSTCODE_CASE_INSENSITIVE, message = "{Pattern.badge.postcode}")
	...
	@Pattern(regexp = ValidationPatterns.PHONE_NUMBER, message = "{Pattern.badge.contactDetailsContactNumber}")
	private String contactDetailsContactNumber;

	@Pattern(regexp = ValidationPatterns.PHONE_NUMBER, message = "{Pattern.badge.contactDetailsSecondaryContactNumber}")
