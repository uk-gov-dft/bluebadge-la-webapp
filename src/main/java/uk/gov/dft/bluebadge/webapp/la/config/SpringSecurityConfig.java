...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity http) throws Exception {
    http.antMatcher("/**")
        ...
        .hasAuthority(Permissions.MANAGE_LOCAL_AUTHORITIES.getPermissionName())
        .antMatchers("/credentials", "/credentials/**")
        .hasAuthority(Permissions.UPDATE_PAY_LA_SECRET.getPermissionName())
        .antMatchers("/credentials", "/credentials/**")
        .hasAuthority(Permissions.UPDATE_NOTIFY_LA_SECRET.getPermissionName())
        .anyRequest()
        .fullyAuthenticated()
        .and()
        .formLogin()
