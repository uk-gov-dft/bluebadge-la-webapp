...
public class OrderBadgePersonDetailsControllerTest extends OrderBadgeBaseControllerTest {
    ...
    public void show_shouldDisplayOrderABadgePersonDetailsTemplate_AndPopulateEligibiltiesAndGenderFieldsFromReferenceDataService() throws Exception {
        ...
        // Mock Data
        referenceData1 = buildReferenceData(RefDataGroupEnum.ELIGIBILITY.getGroupKey(), 1).subgroupShortCode("ELIG_AUTO");
        referenceData2 = buildReferenceData(RefDataGroupEnum.ELIGIBILITY.getGroupKey(), 2).subgroupShortCode("ELIG_AUTO");
        referenceData3 = buildReferenceData(RefDataGroupEnum.ELIGIBILITY.getGroupKey(), 3).subgroupShortCode("ELIG_AUTO");
        referenceData4 = buildReferenceData(RefDataGroupEnum.ELIGIBILITY.getGroupKey(), 4).subgroupShortCode("ELIG_FURTH");
        referenceData5 = buildReferenceData(RefDataGroupEnum.ELIGIBILITY.getGroupKey(), 5).subgroupShortCode("ELIG_FURTH");
        referenceData6 = buildReferenceData(RefDataGroupEnum.ELIGIBILITY.getGroupKey(), 6).subgroupShortCode("ELIG_FURTH");

        referenceDataEligibilityList = Lists.newArrayList(referenceData1, referenceData2, referenceData3, referenceData4, referenceData5, referenceData6);
        ...
        TreeMap<String, List<ReferenceData>> eligibilityMap = new TreeMap<String, List<ReferenceData>>();
        List<ReferenceData> automaticList = Lists.newArrayList(referenceData1, referenceData2, referenceData3);
        List<ReferenceData> furtherList = Lists.newArrayList(referenceData4, referenceData5, referenceData6);
