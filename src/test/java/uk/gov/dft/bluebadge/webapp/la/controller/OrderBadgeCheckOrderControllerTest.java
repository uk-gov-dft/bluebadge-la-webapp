...
public class OrderBadgeCheckOrderControllerTest extends OrderBadgeBaseControllerTest {
    ...
    @Mock
    private OrderBadgeFormsToBadgeOrderRequest converterToServiceModelMock;
    @Mock
    private OrderBadgeFormsToOrderBadgeCheckOrderViewModel converterToViewModelMock;
    ...
    public void submit_shouldRedirectToHomePageAndCreateABadge() throws Exception {
        when(badgeServiceMock.orderABadgeForAPerson(any(), any())).thenReturn(BADGE_NUMBER);
        Contact contact =
                new Contact()
        ...
        verify(badgeServiceMock).orderABadgeForAPerson(badgeOrderRequest, "someBytes".getBytes());
    }
}
