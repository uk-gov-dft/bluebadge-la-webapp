...
public class OrderBadgeFromApplicationSteps extends AbstractSpringSteps {
  ...
  public void iCanSeeOrderBadgeButton() throws Throwable {
    ...
    public void iShouldSeeOrderABadgePagePrefilledWithApplicationDetails() throws Throwable {
        assertThat("I should see page titled.", sitePage.getDocumentTitle(), is("Order a badge - GOV.UK Manage Blue Badges"));
        assertThat("Application type should be ...", sitePage.findElementWithUiPath("applicantType.option.person").getAttribute("checked"), is("true"));
    }
    ...
    public void iShouldSeePersonalDetailsPagePrefilledWithApplicationDetails() throws Throwable {
        ...
        // Personal details
        assertThat("Name field should contain ...", sitePage.findElementWithUiPath("name.field").getAttribute("value"), is("John The First"));
        assertThat("DOB Day field should contain ...", sitePage.findElementWithUiPath("dob.day.field").getAttribute("value"), is("29"));
        assertThat("DOB Month field should contain ...", sitePage.findElementWithUiPath("dob.month.field").getAttribute("value"), is("5"));
        assertThat("DOB Year field should contain ...", sitePage.findElementWithUiPath("dob.year.field").getAttribute("value"), is("1970"));
        assertThat("NINO field should contain ...", sitePage.findElementWithUiPath("nino.field").getAttribute("value"), is("AA234567B"));

        // Address
        assertThat("Building and street field should contain ...", sitePage.findElementWithUiPath("buildingAndStreet.field").getAttribute("value"), is("Contact Building Street"));
        assertThat("Town or city field should contain ...", sitePage.findElementWithUiPath("townOrCity.field").getAttribute("value"), is("Contact Town City"));
        assertThat("Postcode field should contain ...", sitePage.findElementWithUiPath("postcode.field").getAttribute("value"), is("SW11AA"));

        // Contact details
        assertThat("Email address field should contain ...", sitePage.findElementWithUiPath("contactDetailsEmailAddress.field").getAttribute("value"), is("test@mail.com"));

        assertThat("Primary contact number field should contain ...", sitePage.findElementWithUiPath("contactDetailsContactNumber.field").getAttribute("value"), is("0502345678"));
        ...
        // Gender radio
        assertThat("Gender should be ...", sitePage.findElementWithUiPath("gender.option.MALE").getAttribute("checked"), is("true"));

        // Eligibility select
        assertThat("Eligibility type code should be ...", sitePage.findElementWithUiPath("eligibility.field").getAttribute("value"), is("WALKD"));
    }
    ...
    public void iShouldSeeProcessingPagePrefilledWithApplicationDetails() throws Throwable {
        assertThat("I should see page titled.", sitePage.getDocumentTitle(), is("Processing - GOV.UK Manage Blue Badges"));

        assertThat("Gender should be ...", sitePage.findElementWithUiPath("applicationChannel.option.ONLINE").getAttribute("checked"), is("true"));
