...
public class SignInPage extends AbstractSitePage {

    private PageHelper helper;
    private TestContentUrls urlLookup;
    private List<PageElements> pagesElements;

    public SignInPage(WebDriverProvider webDriverProvider, final PageHelper helper) {
    ...
    public String getDocumentContent() {
        return helper.findElement(By.xpath("/html/body/div/main/div/div[3]/div/div/div/ul/li/a/span")).getText();
    }
