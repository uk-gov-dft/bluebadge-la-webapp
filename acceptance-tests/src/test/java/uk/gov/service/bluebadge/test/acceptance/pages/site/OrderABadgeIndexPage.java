...
public class OrderABadgeIndexPage extends AbstractSitePage {

  public OrderABadgeIndexPage(WebDriverProvider webDriverProvider, final PageHelper helper) {
    super(webDriverProvider, helper);
  }
}
